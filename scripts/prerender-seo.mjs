...
const publicRoutes = [
  ...
  },
  {
    ...
    description: '阅读基于 Chrome 版 v1.40.0 源码核验的权限、数据流、保存故障与本地草稿指南。',
  },
  {
    route: '/about',
    ...
    ads: false,
    fallback: '<h1>关于 Flomo Extension</h1><p>Flomo Extension 是由独立开发者维护的 Chrome 浏览器扩展，与 flomo 官方不存在隶属、授权或代言关系。</p><h2>内容如何核验</h2><p>当前文档依据 Chrome 版 v1.40.0 的扩展清单、页面脚本、账户接口调用与本地存储实现核对，并明确标注无法由源码单独证明的结论。</p><p><a href="/posts/flomo-extension-permissions-data-flow">查看权限与数据流依据</a>。</p><h2>联系与反馈</h2><p>产品、账户或内容问题可发送邮件至 <a href="mailto:hotstrip.zx@gmail.com">hotstrip.zx@gmail.com</a>。</p>',
  },
  {
    route: '/privacy',
